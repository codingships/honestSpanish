...
export const ui = {
    es: {
        ...
        pricing: {
            ...
            applicationNote: "La compra directa se abrirá cuando puedas elegir una plaza real con profesor y horario antes de pagar.",
            plans: {
                individual_4x50_28d: {
            ...
            modal: {
                ...
                close: "Cerrar",
                contact: "Compra en preparación",
                contactMessage: "La compra sigue cerrada hasta conectar plazas reales con profesor y horario.",
    ...
    en: {
        ...
        pricing: {
            ...
            applicationNote: "Direct purchase will open once you can choose a real place with a teacher and schedule before paying.",
            plans: {
                individual_4x50_28d: {
            ...
            modal: {
                ...
                close: "Close",
                contact: "Purchase in preparation",
                contactMessage: "Purchasing remains closed until real places with a teacher and schedule are connected.",
    ...
    ru: {
        ...
        pricing: {
            ...
            applicationNote: "Прямая покупка откроется, когда до оплаты можно будет выбрать реальное место, преподавателя и расписание.",
            plans: {
                individual_4x50_28d: {
            ...
            modal: {
                ...
                close: "Закрыть",
                contact: "Покупка готовится",
                contactMessage: "Покупка закрыта до подключения реальных мест с преподавателем и временем.",
