...
- [x] Preflight, backup, limpieza v2 y rollout production preparados fail-closed: `pnpm launch:supabase-production-readonly-preflight` y `pnpm launch:supabase-production-rollout-plan` fijan el target exacto `vkkahxsybhbutszerawz`, 23 migraciones por hash en siete olas, `20260710150000` excluida, verificacion por efectos e historial source-bound, y prohibicion de `supabase db push`, `supabase migration repair`, restore o switch automaticos. Los modos por defecto son locales/read-only y checkout debe permanecer desactivado. Los hashes de `20260712112000` y `20260712114000` quedan fijados por los runners; cualquier cambio de SQL invalida la evidencia. Evidencia base anterior: `outputs/launch-supabase-production-readonly-preflight/2026-07-12T10-03-23-365Z/summary.md`, `outputs/launch-supabase-production-rollout-plan/2026-07-12T10-05-21-802Z/summary.md`.
...
- [ ] Aplicar realmente y verificar en Supabase staging, en orden, `20260712112000`, `20260712114000` y `20260712114500`; production exige cierre `APPLIED_AND_VERIFIED`, no plan ni `ALREADY_APPLIED`. Verificar contrato de `leads`, grants/helper admin, trigger/indices, solapes y signup 18+.
