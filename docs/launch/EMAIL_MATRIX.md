...
| Email de prueba admin | Admin | `buildEmailPreview` / `sendEmailPreview` | `src/pages/api/email/send-test.ts` | No aplica; herramienta interna de verificacion | Implementado |
