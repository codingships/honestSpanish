...
| U01 | UX/UI pública coherente en escritorio y móvil | PARCIAL | [PR #65](https://github.com/codingships/honestSpanish/pull/65), [componentes públicos](../src/components), [E2E público](../tests/e2e) y [staging `1706b98`](https://github.com/codingships/honestSpanish/actions/runs/30901236505) | Completar la revisión visual representativa, estados y confianza; menú móvil y fallo seguro sin JavaScript ya tienen cobertura. |
| U02 | Tipografía coherente ES/EN/RU | VERIFICADO | [PR #66](https://github.com/codingships/honestSpanish/pull/66), [fuentes autocontenidas](../src/styles/fonts.css), [prueba pública](../tests/e2e/typography.public.spec.ts) y [staging del descendiente `1706b98`](https://github.com/codingships/honestSpanish/actions/runs/30901236505) | Mantener la prueba visual al añadir alfabetos o cambiar familias. |
