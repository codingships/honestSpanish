...
Treat the current task, code, migrations, executable configuration, and tests as the source of truth. Read durable documentation only when relevant: `docs/PRODUCT.md` for offer or copy, `docs/ENVIRONMENTS.md` and `docs/OPERATIONS.md` for providers or deployment, and `ARCHITECTURE.md` for structural changes.
