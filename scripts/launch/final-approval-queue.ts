    ...
    return [
        {
            ...
            target: 'Supabase production vkkahxsybhbutszerawz through source-bound rollout wave processed_at_small_fix; staging mzjyvmlxfpzdfdjzxxyj is already applied and read-only verified',
            approvalPath: latestGeneratedPath('launch-supabase-production-rollout-runner', 'exact-approval-required.txt'),
            supportPaths: existingOrExpected([
                ...
                latestGeneratedPath('launch-supabase-production-readonly-preflight', 'summary.json'),
                latestGeneratedPath('launch-supabase-production-rollout-runner', 'summary.json'),
                latestGeneratedPath('launch-supabase-production-rollout-runner', 'manifest.json'),
                latestGeneratedPath('launch-supabase-production-rollout-runner', 'wave-processed_at_small_fix-apply.sql'),
                latestGeneratedPath('launch-supabase-production-rollout-runner', 'wave-processed_at_small_fix-verify-readonly.sql'),
            ...
            allowedScope: 'Apply only the source-bound production rollout wave processed_at_small_fix, or include it as the first wave of the exact 22-migration production rollout; verify migration history hash, absent default and clean webhook aggregates read-only.',
            forbiddenScope: [
