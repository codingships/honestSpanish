...
WITH canonical_packages AS (
    ...
    SELECT jsonb_build_object(
        ...
        'jobs_cancel_session', (SELECT count(*) FROM public.jobs WHERE kind = 'scheduling.cancel_session'),
        'jobs_welcome', (SELECT count(*) FROM public.jobs WHERE kind = 'billing.send_welcome_email'),
        'jobs_provision', (SELECT count(*) FROM public.jobs WHERE kind = 'scheduling.provision_session'),
        'jobs_reminder', (SELECT count(*) FROM public.jobs WHERE kind = 'scheduling.send_session_reminder'),
        'jobs_create_drive_folder', (SELECT count(*) FROM public.jobs WHERE kind = 'billing.create_student_drive_folder'),
