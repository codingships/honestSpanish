...
function renderFinalSmokeWorksheet(report: FinalReadinessReport): string {
    const lines = [
        ...
        '- `pnpm exec tsx scripts/smoke-checkout.ts`: exceptional manual narrow-checkout diagnostic, not part of the active launch-smoke path; its bootstrap mode requires explicit external gate ownership.',
        '',
        '## Manual Checks',
        '',
