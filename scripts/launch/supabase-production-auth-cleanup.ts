...
function writePlan(outputDir: string): void {
    ...
    writeSummary(outputDir, {
        ...
        operation: {
            ...
            finalProfiles: 'created only after all 22 rollout waves and quarantine expiry',
        ...
        sequence: [
            ...
            'Apply all 22 allowlisted waves while production remains quarantined.',
...
async function runDeletePhase(
    ...
    try {
        ...
        writeSummary(outputDir, {
            ...
            externalProvidersTouched: false,
            googleDriveFixtureFolders: 'UNTOUCHED_110_OBSERVED',
            nextAction: 'Keep production inert; apply the 22 rollout waves using this receipt, then wait until quarantineUntil before Auth finalize.',
        });
